...
One very interesting feature in dimension 2 is the role of the three dimensional variables: non-aesthetical but commercial and political appear on the upper side of the x axis, and aesthetical but non-commercial and non-political on the lower side of the x axix. 

## Conclusions and discussion

As an exercise this assaignment was really succesful: I managed to handle a real, existing (and large) data with R, I used a method that I was not familiar before, and I found some useful results for our project for further analysis.
