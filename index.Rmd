...
Multiple correspondence analysis (MCA) is an unsupervised dimensionality reduction technique. It is suitable for nominal categorical variables. Compared to correspondence analysis (CA) it is possible to analyse more than two variables at the same time. MCA is a useful tool for visualizing large datasets.
